                        ...
                        <div class="item_wrap">
                            ...
                            <div class="item_body flex mb_8">
                                <div class="input_wrap input_year">
                                    <el-select v-model="resume.getyear" @change="setResume()" placeholder="1996" class="input_year">
                                        <el-option
                                        v-for="item in resume.getyears"
                                        :key="item.value"
                                        :label="item.label"
                                        :value="item.value">
                                        </el-option>
                                ...
                                <div class="input_wrap">
                                    <el-select v-model="resume.getmonth" @change="setResume()" placeholder="1" class="input_month">
                                        <el-option
                                        v-for="item in resume.getmonths"
                                        :key="item.value"
                                        :label="item.label"
                                        :value="item.value">
                                        </el-option>
